...
public class Slider2D : Selectable, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
{
    ...
    [SerializeField]
    private Float2Event m_OnValueChanged = new Float2Event();
    public Float2Event OnValueChanged { get { return m_OnValueChanged; } set { m_OnValueChanged = value; } }

    public FloatEvent OnXChanged = new FloatEvent();
    public FloatEvent OnYChanged = new FloatEvent();
